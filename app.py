...
# ✅ FIX: langchain_classic हटाया, official imports use
...
# Optional LangSmith (only if key present)
...
def get_google_search_tool():
    # Needs GOOGLE_API_KEY and GOOGLE_CSE_ID in secrets/env
